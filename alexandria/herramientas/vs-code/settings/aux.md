```json
{
    ...
    "pgsql.serverGroups": [
        {
            "name": "Servers",
            "id": "2B2851B0-EE4D-4D7E-A1EA-E44C995ED427",
            "isDefault": true
        }
    ],
    ...
    "tabstronaut.keybindingOrder": false,
...
,
    ...
    "zeng-color-picker.Filter.ApplyForTheseLanguages": "html,css,javascript,typescript,xml,json",
    ...
    "plantuml.render": "PlantUMLServer",//plantuml
    "plantuml.server": "http://localhost:8080/plantuml",//servidor local de plantuml
