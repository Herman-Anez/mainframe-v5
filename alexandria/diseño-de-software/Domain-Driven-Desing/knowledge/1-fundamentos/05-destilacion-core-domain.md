...
Estos cinco archivos sientan la base para abordar el resto del repositorio DDD, desde los patrones tácticos hasta las arquitecturas de implementación. El entendimiento profundo de estos fundamentos es lo que diferencia a un proyecto que simplemente usa algunas prácticas DDD de uno que verdaderamente maneja la complejidad del negocio desde la estrategia hasta el código.
...
| :--- | :---: | ---: |
| [◀ Context mapping](04-context-mapping.md) | [🏠 Inicio](../index.md) | [Event storming ▶](../2-diseno-estrategico/01-event-storming.md) |
